<html lang="en"><head>
    ...
    <!-- MetisMenu CSS -->
    <link href="http://127.0.0.1:8000/css/metisMenu.min.css" rel="stylesheet">
    <!-- Custom CSS -->
    
    <link href="http://127.0.0.1:8000/css/sb-admin-2.css" rel="stylesheet">
    <!-- Custom Fonts -->
...
<body>
    ...
    <script src="http://127.0.0.1:8000/js/metisMenu.min.js"></script>

    <!-- Custom Theme JavaScript -->
    <script src="http://127.0.0.1:8000/js/sb-admin-2.js"></script>
